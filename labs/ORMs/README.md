...
Baseado neste artigo: [Why you should avoid using ORMs in Node.JS](https://blog.logrocket.com/why-you-should-avoid-orms-with-examples-in-node-js-e0baab73fa5)
